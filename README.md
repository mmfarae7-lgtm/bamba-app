...
- من داخل التطبيق: الإعدادات → "تنزيل المشروع (ZIP)" — يشمل الشعار والأيقونات وملفات SQL
- رابط مباشر: `/downloads/bamba-app.zip` — يُعاد توليده من آخر commit (مناسب للجوال)
