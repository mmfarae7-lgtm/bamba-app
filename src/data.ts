import type { Match, TeamStanding, Scorer, LeagueGroup, RankingUser, Challenge, Player } from './types';
...
export const leagueGroups: LeagueGroup[] = [
  ...
  { title: 'بطولات الأندية القارية', items: ['دوري أبطال أوروبا', 'دوري أبطال إفريقيا', 'دوري أبطال آسيا', 'الدوري الأوروبي'] },
  { title: 'بطولات المنتخبات', items: ['كأس الأمم الأوروبية', 'كوبا أمريكا', 'كأس أمم إفريقيا', 'كأس أمم آسيا'] },
  { title: 'بطولات الفيفا', items: ['كأس العالم للمنتخبات', 'كأس العالم للأندية'] },
];
...
export const ranking: RankingUser[] = [
  { name: 'معصتم', points: 912, country: 'مصر', rank: 1, bamba: 15200 },
  { name: 'اليامامة', points: 899, country: 'السعودية', rank: 2, bamba: 12100 },
  { name: 'Nasser', points: 894, country: 'أمريكا', rank: 3, bamba: 9800 },
  { name: 'حمد قاسم', points: 890, country: 'قطر', rank: 4, bamba: 8400 },
  { name: 'مدحت عبدالرقـيب', points: 888, country: 'مصر', rank: 5, bamba: 7600 },
  { name: 'Ahmed Taha', points: 879, country: 'بريطانيا', rank: 6, bamba: 6200 },
  { name: 'سارة الأحمد', points: 865, country: 'السعودية', rank: 7, bamba: 5500 },
  { name: 'Khaled', points: 851, country: 'الإمارات', rank: 8, bamba: 4800 },
  { name: 'عمر فاروق', points: 840, country: 'مصر', rank: 9, bamba: 4100 },
  { name: 'Layla', points: 832, country: 'الأردن', rank: 10, bamba: 3900 },
];

export const winners = [
  { period: 'الأسبوع 12', name: 'معصتم', prize: '500 بمبة + نجمة ذهبية', rank: 1 },
  { period: 'الأسبوع 12', name: 'اليامامة', prize: '300 بمبة + نجمة فضية', rank: 2 },
  { period: 'الأسبوع 12', name: 'Nasser', prize: '150 بمبة + نجمة برونزية', rank: 3 },
  { period: 'شهر يناير', name: 'حمد قاسم', prize: '2000 بمبة + كأس الشهر', rank: 1 },
  { period: 'شهر يناير', name: 'معصتم', prize: '1000 بمبة', rank: 2 },
  { period: 'شهر يناير', name: 'مدحت عبدالرقـيب', prize: '500 بمبة', rank: 3 },
];
