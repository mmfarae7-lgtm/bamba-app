...
const TEAM_LEAGUE: Record<string, string> = {
  'مانشستر سيتي': 'الدوري الإنجليزي', 'ليفربول': 'الدوري الإنجليزي', 'أرسنال': 'الدوري الإنجليزي', 'توتنهام': 'الدوري الإنجليزي',
  'ريال مدريد': 'الدوري الإسباني', 'برشلونة': 'الدوري الإسباني', 'أتلتيكو مدريد': 'الدوري الإسباني',
  'بايرن ميونخ': 'الدوري الألماني',
  'باريس سان جيرمان': 'الدوري الفرنسي',
  'النصر': 'دوري روشن السعودي', 'الهلال': 'دوري روشن السعودي',
};
